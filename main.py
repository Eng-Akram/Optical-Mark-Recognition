...
# ---------------------------------------- extracting the answers one by one ----------------------------
# chunks = [bubbled[x:x + 4] for x in range(0, len(bubbled), 4)]
# column1 = []
# column2 = []
# column3 = []
# column4 = []
# for i in range(4):
#     for j in range(i, 152, 4):
#         if i == 0:
#             column1.append(chunks[j])
#         if i == 1:
#             column2.append(chunks[j])
#         if i == 2:
#             column3.append(chunks[j])
#         if i == 3:
#             column4.append(chunks[j])
#
# student_answers = column1 + column2 + column3 + column4
# real_answers = {i: 1 for i in range(1, 153)}
# correct = 0
# for i in range(152):
#     question = student_answers[i]
#     print(question)
        ...
        if 1 in bubbles:
            ...
            for i in range(0, 608, 4):
                if bubbles[i] == answers[i] and bubbles[i + 1] == answers[i + 1] and bubbles[i + 2] == answers[
                    ...
                    grade += 1
            # ------------------------- renaming files with name and grade -----------------
            print(q.name, grade)
            open_brackets = "("
            close_brackets = ")"
            str_grade = str(grade)
